...
16. Ομαδοποιήσαμε τα δεδομένα με βάση το τμήμα και το επίπεδο επείγοντος. Στην συνέχεια, υπολογίσαμε τον μεσο χρόνο αναμονής, το ποσοστό  περιστατικών που οδήγησαν σε νοσηλεία  και τον αριθμό ασθενών που νοσηλεύτηκαν στο συγκεκριμένο τμήμα και βαθμό επείγοντος. Το ζητούμενο ποσοστό ερμηνεύτηκε ως το ποσοστό του συνολικού πληθυσμού που επισκέφτηκε το νοσοκομείο (triage), ήταν στο τάδε τμήμα για το τάδε επίπεδο επείγοντος και νοσηλεύτηκαν.
